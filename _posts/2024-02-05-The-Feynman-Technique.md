...
在他的研究生涯中，他发明了独属于他的思维模型[^1]，学习方法和学习工具。费曼学习法，主要是基于费曼在普林斯顿大学学习时使用的一种方法。[《费曼传》](https://book.douban.com/subject/1077935/)的作者詹姆斯·格雷克，写过下面一段话：

> 他打开了一本崭新的笔记本，在标题页上，他写道：记录我不知道东西的笔记本。这是他第一次重新整理他学到的知识。他花了数周将物理学的每一个分支拆分开，（就像拆解一辆汽车那样，）然后给每个零部件上油，最后又将它们拼装在一起。整个过程中，他一直在寻找存在问题或者理论不一致的地方。（一言以蔽之，）他努力地在寻找每一个分支的核心。
...
> 从整个人类的发展来看，我们还处于非常早期的阶段。这样说是因为我们仍有许等待解决的难题，但是未来还有很长很长的时间，我们的使命是做好我们能做的事，学好我们能学的知识，不断改进解决办法，然后将这些传给我们的下一代。 —— 理查德·费曼
...
每当你学了一些新东西的时候，你要理解其中的核心概念，并建立基础的思维模型[^1]，然后在扎实的基础上，一步步地理解更复杂的概念。理查德·费曼是一位伟大的讲师，这是因为他知道新知识要由最基本的原理开始一点一点被引入。
...
> 费曼是20世纪最伟大的物理学家之一，是一位独辟蹊径的思考者、保险柜破译高手、玛雅文字破译者、原子弹之父，以及更广为人知的诺贝尔物理学奖[^4]得主。
...
> 费曼身上具有一种奇特的魔力。第一次遇到费曼的人马上会为他的才华所倾倒，同时又会对他的幽默感到吃惊。物理学家弗里曼·戴森起初对费曼的印象是：“半是天才，半是滑稽演员。”后来，当戴森对费曼非常了解之后，他把原来的评价修改为“完全是天才，完全是滑稽演员。”
...
关于费曼学习法，嗯...翻译有意思的文章其实就是啦！戳:point_right:[这里](https://wuhulamb.github.io/categories/translation.html)可以找到全部翻译的文章，祝学的愉快！

---

[^1]: 指对事物如何运作的理解，详见:point_right: [思维模型：如何训练你的大脑以新的方式思考（英文）](https://jamesclear.com/feynman-mental-models)
[^2]: 计算机术语，指重复某一过程，每一次迭代得到的结果会作为下一次迭代的初始值，详见:point_right: [百度百科](https://baike.baidu.com/item/%E8%BF%AD%E4%BB%A3%E7%AE%97%E6%B3%95/54579021)
[^3]: 相关书籍链接替换为了豆瓣中对应的中文版链接，其余链接均保持原样（正文中结论部分《将爱传递下去》替换为了豆瓣电影链接）
[^4]: 1965年费曼（47岁）因在量子电动力学方面的贡献与施温格、朝永振一郎一同获得诺贝尔物理奖
