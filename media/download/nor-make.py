...
#m, d, y = 10, 17, 2023                           # 正式投入使用时请注释本行|与星期需匹配
...
if __name__ == '__main__':
    ...
    print(r'''         
                                         _                     
        ._ _  ___  _ _  ___ ._ _ _  ___ | |__ ___     ___  _ _ 
        | ' |/ . \| '_>|___|| ' ' |<_> || / // ._> _ | . \| | |
        |_|_|\___/|_|       |_|_|_|<___||_\_\\___.<_>|  _/`_. |
                                                     |_|  <___'
...
\ \ \_/ \_/ \ \ \_\ \\ \ \ \ \ \ \_\ \ \_\ \_/\ \L\.\_/\ \/\ \/\ \ \ \L\ \
 \ \___x___/'\ \____/ \ \_\ \_\ \____/ /\____\ \__/.\_\ \_\ \_\ \_\ \_,__/
  \/__//__/   \/___/   \/_/\/_/\/___/  \/____/\/__/\/_/\/_/\/_/\/_/\/___/ 
    ...
    4. 添加：X月X日{place}第X-X节到课情况统计表（{weekNum2Str[whichweek(m, d, y)]}周X）
    5. 到课率低于70%标黄
    6. 字体、字号、行高、列宽、边框
    7. 添加最后一行的备注说明
    ''')
